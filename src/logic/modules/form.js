...
export default class Mailbox {
    ...
    constructor({
        // destructure configuration arguments
        id = 'form_1',
        form = 'form',
        carrier,
        destination,
    ...
    send(event) {
        ...
        this.runSpamFilter()
            .then((token) => {
                ...
                for the 'content-type' header sent with the request. As such, if you're
                using Node/Express, you'll need to use a package like 'multer' that can
                handle multipart data and add the form values to request.body.
                **********************************************************************/
